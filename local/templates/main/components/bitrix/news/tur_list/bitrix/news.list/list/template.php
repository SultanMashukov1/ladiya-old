                    ...
                    <? if(!empty($arResult['ITEMS'])) : ?>
                        <p>
                            <?=Helper::pluralize($foundCnt, array(
                                Loc::getMessage('LIST_TOUR_SEARCH_FOUND_ONE_TITLE'),
                                Loc::getMessage('LIST_TOUR_SEARCH_FOUND_MORE_TITLE'),
                                Loc::getMessage('LIST_TOUR_SEARCH_FOUND_MORE_TITLE'),
                            ));?>
                            <?=Helper::pluralizeN($foundCnt, array(
                                Loc::getMessage('LIST_TOUR_TOUR_ONE'),
                                Loc::getMessage('LIST_TOUR_TOUR_TWO'),
                                Loc::getMessage('LIST_TOUR_TOUR_MORE'),
                            ));?>
                        </p>
                    <? else: ?>
                        <p><?=Loc::getMessage('LIST_TOUR_SEARCH_NOT_FOUND_TITLE');?></p>
                    <? endif; ?>
                </div>
                                ...
                                <div class="catalog__list__item__img__wrap__table">
                                    ...
                                    <?=$arItem["PREVIEW_TEXT"];?>
                                        ...
                                        <div class="catalog__list__item__img__wrap__btn">
                                            <?=Loc::getMessage('LIST_TOUR_SEARCH_MORE_BTN_TITLE');?>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="catalog__list__item__inf">
                            <? if(Helper::propFilled('HEADER', $arItem)) : ?>
                                <div class="catalog__list__item__inf__text">
                                    <?=Helper::escPropValue('HEADER', $arItem);?>
                                </div>
                            <?endif;?>
                            <div class="catalog__list__item__inf__footer">
                                    ...
                                    <? if(Helper::propFilled('DAY', $arItem)) : ?>
                                        <span>
                                            <?=Helper::pluralizeN(Helper::escPropValue('DAY', $arItem), array(
                                                Loc::getMessage('LIST_TOUR_DAY_ONE'),
                                                Loc::getMessage('LIST_TOUR_DAY_TWO'),
                                                Loc::getMessage('LIST_TOUR_DAY_MORE'),
                                            ));?>   
                                         </span>
                                    <? endif; ?>
                                    <? if(Helper::propFilled('NIGHT', $arItem)) : ?>
                                        <span>
                                            <?=Helper::pluralizeN(Helper::escPropValue('NIGHT', $arItem), array(
                                                Loc::getMessage('LIST_TOUR_NIGHT_ONE'),
                                                Loc::getMessage('LIST_TOUR_NIGHT_TWO'),
                                                Loc::getMessage('LIST_TOUR_NIGHT_MORE'),
                                            ));?>
                                        </span>
                                    <? endif; ?>
                                </div>
                                <div class="catalog__list__item__inf__price">
                                    <? if(Helper::propFilled('PRICE', $arItem)) : ?>
                                        <?=Loc::getMessage('LIST_TOUR_PRICE_FROM');?>
